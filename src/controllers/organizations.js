...
const processEditOrganizationForm = async (req, res) => {
    ...
    // Here you would call a model function to update the organization in the database
    // For example: await updateOrganization(organizationId, name, description, contactEmail, logoFilename);    
    await updateOrganization(organizationId, name, description, contactEmail, logoFilename);
    // set a success flash massage 
